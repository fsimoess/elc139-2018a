...
void nqueens(int size, int *solutions) {
  ...
  /**
  fazer o reduction na variavel count, pq todas threads vao usar a mesma variavel count, q
    é declarada fora da regiao paralela, e todas tem q atualizar nessa mesma variavel, ai o reduction facilita isso 
  **/
